...
<div id="accueil" class=" text-center">
    ...
    <p>
        Notre activité principale est de confectionner des arcticles fait main en laine coton ou tissu et de les remettre à d'autre organisme qui en aurait besoin comme les service pédiatriques hospitaliers et les maisons de retraites.
        <span class="m-top">
        Mais nous acceptons aussi toute sortes de dons, matériels ou financiers, afin de venir en aide de diverses façons à un maximum de profils différent (allant d'aides au financement de voyages scolaires aux dons de vêtements collectés).
        </span>
    </p>

    <p>
        L'association est aussi active sur les résaux sociaux Facebook, Instagram, Youtube et Tik Tok.
        <span class='m-top'>Nous postons sur ces plateformes des tutos créations ansi que des concours organisés par nos soins, mais aussi des lives afin d'échanger avec vous sur les projets en cours.</span>
    </p>
